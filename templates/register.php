      ...
      <div class="content">
        ...
        <main class="content__main">
          ...
          <form class="form" action="/registration.php" method="post">
					<p class="error-message"><?=!empty($email['error'].$password['error'].$name['error'])?'Пожалуйста, исправьте ошибки в форме':''?></p>
            <div class="form__row">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?=$name['error']?>" type="text" name="name" id="name" value="<?=htmlspecialchars($name['main'])?>" placeholder="Введите имя">
