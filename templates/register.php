        ...
        <main class="content__main">
          ...
          <form class="form" action="/registration.php" method="post">
            <div class="form__row">
              ...
              <input class="form__input <?=$email['error']?>" type="text" name="email" id="email" value="<?=htmlspecialchars($email['email'])?>" placeholder="Введите e-mail">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?=$name['error']?>" type="text" name="name" id="name" value="<?=htmlspecialchars($name['name'])?>" placeholder="Введите имя">
              <p class="form__message"><?=$name['error_message']?></p>
            </div>

            <div class="form__row form__row--controls">
              <p class="error-message"><?=$error===1?'Пожалуйста, исправьте ошибки в форме':''?></p>
